...
public final class Constants {
    ...
    public static final class MotorConstants {
        ...
        public static final double kElevatorMaxHeight = 0.975;
        public static final double kElevatorMinHeight = 0.160;
    ...
    public static final class PIDConstants {
        ...
        public static final double kShooterTransitSetpoint = .255;
        public static final double kShooterIntakeSetpoint = .2;
        public static final double kShooterScoreSetpoint = .1;
        public static final double kElevatorTransitSetpoint = .255;
        public static final double kElevatorIntakeSetpoint = .2;
        public static final double kElevatorScoreSetpoint = .1;
    }
}
